            ...
            get
            {
                ...
                try
                {
                    ...
                    if (authorization != null)
                    {
                        ...
                        //merve:12345
                        bool usernameResult = usernamepassword.Split(':').First()
                            .Equals(ConfigurationManager.AppSettings["USERNAME"].ToString());

                        bool passwordResult = usernamepassword.Split(':').Last()
                            .Equals(ConfigurationManager.AppSettings["PASSWORD"].ToString());

                        //USERNAME VE PASSWORD doğru geldiyse kontrol etsin RESULT'a true atasın. Doğru değilse FALSE atasın.
